import com.example.ayuan.license.AESUtils;
import com.example.ayuan.license.DateUtils;
...
public class CreateSign {
    ...
    public static void main(String[] args) throws NoSuchPaddingException, IllegalBlockSizeException, NoSuchAlgorithmException, BadPaddingException, InvalidKeyException {
        ...
        String systemSign = LicenseManager.getLicense();
        // 生效起始时间
        String generatedTimeStr = "2023-06-06 00:00:00";
        // 生效截止时间
        String expiredTimeStr = "2024-05-11 00:00:00";
        // 上一次校验时间（初始值）
        String lastValidateTimeStr = "2023-06-06 00:00:01";
        // 项目部署序列号（版本标识）
        String version = "dmoiji3xkoa4p33";
        // license生成路径
        String path = "/Applications/soft/just4play/license.xml";
...
//            String macAndCpu = "A8:A1:59:41:89:36-BFEBFBFF000906EA-20220506-20220507-dmoiji3xkoa4p33";
